...
$('head').prepend('<link rel="stylesheet" href="template/classic/css/docs.css" type="text/css" media="screen">');
...
$('body').prepend('<div id="panel"><div class="navbar navbar-inverse navbar-fixed-top" id="advanced"></div></div>');
