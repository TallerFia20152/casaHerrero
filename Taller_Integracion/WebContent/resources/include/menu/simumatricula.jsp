	...
	<li><a href="#"> <i class="entypo-gauge"></i><span class="title">SIMULACI&Oacute;N DE MATRICULA</span></a>
		<ul>
			...
			<li><a href="<%=request.getContextPath()%>/SimulacionInicial"><span class="title"> Simulaci&oacute;n Matricula Inicial</span></a></li> 
			
			<li><a href="<%=request.getContextPath()%>/SimulacionProbable"><span class="title">Simulaci&oacute;n Matricula Probable</span></a></li>
			<li><a href="<%=request.getContextPath()%>/SimulacionPreferido"><span class="title">Simulaci&oacute;n Matricula Preferible</span></a></li>
			<li>
			...
			<li><a href="#"> <i class="entypo-gauge"></i><span class="title">MAT PROGRESIVA-ALUMNO</span></a>
				<ul>					
					<li><a href="<%=request.getContextPath()%>/AlumnoListarCursosAptos"><span class="title">Cursos Aptos</span></a></li>					 
					<li><a href="<%=request.getContextPath()%>/AlumnoListarCursosPropuestos"><span class="title">Cursos Probables</span></a></li> 
					
					<li><a href="<%=request.getContextPath()%>/ListarCursosAptosPreferibles"><span class="title">Cursos Preferibles</span></a></li>
					<li><a href="<%=request.getContextPath()%>/SeleccionarHorarios"><span class="title">Escoger Horarios</span></a></li>
