					...
					<div class="mail-compose">
						...
						<form method="post" role="form">
							...
							<div class="form-group">
								<label for="to">Para:</label> <input type="text"
									class="form-control" id="to" tabindex="1" />								
							</div>

							<div class="form-group">
								<label for="subject">Asunto:</label> <input type="text"
									class="form-control" id="subject" tabindex="1" />
							</div>
							...
							<div class="compose-message-editor">
								<textarea class="form-control wysihtml5"
									...
									name="sample_wysiwyg" id="sample_wysiwyg"></textarea>
							</div>
