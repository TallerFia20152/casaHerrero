	...
	<div id="div-change" style="padding-top: 5px">
		<div class="row">
			<div class="col-md-12 opcion">
				<a download="PlanCurricular_CambiosGenerados.xls" href="" onclick="return ExcellentExport.excel(this, 'tb-change');" class="btn btn-lg btn-black">
					Exportar
				</a>
			</div>
			<p/>
...
<div class="ui-layout-east">
	...
	<div id="div-curriculum" style="padding-top: 0px">
		<jsp:include page="/PlanCurricular/views/sections/tableCurriculum.jsp"/>
	</div>
</div>
