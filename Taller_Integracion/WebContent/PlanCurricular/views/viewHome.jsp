...
<script type="text/javascript" src='<c:url value="/PlanCurricular/resources/js/excellentexport.js" />'></script>
	...
	<div id="div-change" style="padding-top: 5px">
		...
		<div class="row">
			<div class="col-md-12 opcion">
				<a download="PlanCurricular_CambiosGenerados.xls" href="" onclick="return ExcellentExport.excel(this, 'tb-change');" class="ui-form-buttons">
					Exportar
				</a>
			</div>
			<p/>
