 ...
 */
@WebServlet("/moveCourse")
public class CHGMoveServlet extends HttpServlet implements Constants {
	...
	protected void doGet(HttpServletRequest request,
		...
		RequestDispatcher reqDisp = getServletContext().getRequestDispatcher("/" + 
				VIEW_SECTION_PATH + "formMoveCourse.jsp");
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String[] mention 	= request.getParameterValues("mention");
			...
			ChangeBean change 			= chgBusiness.moveCourse(course, type, cycle, mention, courses, newCourses, changes);
