...
public class CHGRemoveServler extends HttpServlet implements Constants {
	...
	protected void doGet(HttpServletRequest request,
		...
		RequestDispatcher reqDisp = getServletContext().getRequestDispatcher("/" + 
				VIEW_SECTION_PATH + "formCancelCourse.jsp");
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//String newCourse 	= request.getParameter("ncourse");
			...
			ChangeBean change 			= chgBusiness.cancelCourse(course, courses, newCourses, changes);
