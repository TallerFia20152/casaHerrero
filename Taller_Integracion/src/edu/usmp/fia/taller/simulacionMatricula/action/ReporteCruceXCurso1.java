...
/**
 * Servlet implementation class ReporteCruceXCurso1
 */
@WebServlet("/ReporteCruceXCurso1")
public class ReporteCruceXCurso1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReporteCruceXCurso1() {
        super();
